...
from .session_resource import SessionResourceManager
    ...
    async def _handle_stateful_request(
        ...
        if request_mcp_session_id is None:
            ...
            async with self._session_creation_lock:
                ...
                if self._session_resource_manager:
                    await self._session_resource_manager.create(new_session_id)
                    ...
                    async with http_transport.connect() as streams:
                        ...
                        try:
                            ...
                            if (
                                ...
                                if self._session_resource_manager:
                                    await self._session_resource_manager.destroy(
                                        http_transport.mcp_session_id
                                    )
