...
class SseServerTransport:
    ...
    def __init__(
        ...
        session_resource_manager: SessionResourceManager = None,
    ) -> None:
        """
    ...
    async def connect_sse(self, scope: Scope, receive: Receive, send: Send):
        ...
        if self._session_resource_manager:
            await self._session_resource_manager.create(session_id.hex)
        ...
        async with anyio.create_task_group() as tg:
            ...
            async def response_wrapper(scope: Scope, receive: Receive, send: Send):
                ...
                if self._session_resource_manager:
                    await self._session_resource_manager.destroy(session_id.hex)
