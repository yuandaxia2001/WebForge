...
from aiground.framework.thirdparty.mcp.server.fastmcp.exceptions import InvalidSignature
from aiground.framework.thirdparty.mcp.server.fastmcp.utilities.logging import (
    get_logger,
)
from aiground.framework.thirdparty.mcp.server.fastmcp.utilities.types import Image
from aiground.framework.thirdparty.mcp.types import ContentBlock, TextContent
    ...
    **critically** it also provides pre-parse helper to attempt to parse things from
    ...
    for param in params.values():
        ...
        if hasattr(BaseModel, param.name) and callable(getattr(BaseModel, param.name)):
            ...
            dynamic_pydantic_model_params[internal_name] = (
