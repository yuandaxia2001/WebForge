...
from aiground.framework.thirdparty.mcp.shared.message import (
    ServerMessageMetadata,
    SessionMessage,
)
from aiground.framework.thirdparty.mcp.shared.version import SUPPORTED_PROTOCOL_VERSIONS
...
class StreamableHTTPServerTransport:
    ...
    async def terminate(self) -> None:
        ...
        if self._session_resource_manager:
            await self._session_resource_manager.destroy(self.mcp_session_id)
