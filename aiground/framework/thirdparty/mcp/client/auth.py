...
from aiground.framework.thirdparty.mcp.shared.auth_utils import (
    check_resource_allowed,
    resource_url_from_server_url,
)
from aiground.framework.thirdparty.mcp.types import LATEST_PROTOCOL_VERSION
...
class OAuthClientProvider(httpx.Auth):
    ...
    def _extract_resource_metadata_from_www_auth(
        self, init_response: httpx.Response
    ) -> str | None:
        """
