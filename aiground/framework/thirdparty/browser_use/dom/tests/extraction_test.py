            ...
            while True:
                try:
                    ...
                    async with await anyio.open_file(
                        "./tmp/user_message.txt", "w", encoding="utf-8"
                    ) as f:
                        await f.write(user_message)

                    token_count, price = count_string_tokens(
                        user_message, model="gpt-4o"
                    )
                    print(
                        f"Prompt token count: {token_count}, price: {round(price, 4)} USD"
                    )
                    ...
                    answer = input(
                        "Enter element index to click, 'index,text' to input, or 'q' to quit: "
                    )
                        ...
                        if "," in answer:
                            ...
                            try:
                                ...
                                if clicked_index in selector_map:
                                    ...
                                    print(
                                        f"Clicking element {clicked_index}: {element_node.tag_name}"
                                    )
                                ...
                                print(
                                    f"Invalid input: '{answer}'. Enter an index, 'index,text', or 'q'."
                                )
