...
class RegisteredAction(BaseModel):
    ...
    domains: Optional[list[str]] = (
        None  # e.g. ['*.google.com', 'www.bing.com', 'yahoo.*]
    )
...
class ActionRegistry(BaseModel):
    ...
    @staticmethod
    def _match_domains(domains: Optional[list[str]], url: str) -> bool:
        """
    ...
    @staticmethod
    def _match_page_filter(
        page_filter: Optional[Callable[[Page], bool]], page: Page
    ) -> bool:
