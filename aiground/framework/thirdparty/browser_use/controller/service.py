...
from aiground.framework.thirdparty.browser_use.controller.registry.service import (
    Registry,
)
from aiground.framework.thirdparty.browser_use.controller.views import (
    ClickElementAction,
    CloseTabAction,
    DoneAction,
    DragDropAction,
    ...
    def __init__(
        ...
        async def search_google(params: SearchGoogleAction, browser: BrowserContext):
            ...
            try:
                ...
                logger.debug("Page load state timeout (5s) after search_google, continuing anyway")
            except Exception as e:
                logger.debug(f"Page load state check failed after search_google: {e}, continuing anyway")
