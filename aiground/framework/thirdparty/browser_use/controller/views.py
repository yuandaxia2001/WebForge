...
class DragDropAction(BaseModel):
    ...
    element_source: Optional[str] = Field(
        None, description="CSS selector or XPath of the element to drag from"
    )
    element_target: Optional[str] = Field(
        None, description="CSS selector or XPath of the element to drop onto"
    )
    ...
    coord_source_x: Optional[int] = Field(
        None, description="Absolute X coordinate on page to start drag from (in pixels)"
    )
    coord_source_y: Optional[int] = Field(
        None, description="Absolute Y coordinate on page to start drag from (in pixels)"
    )
    coord_target_x: Optional[int] = Field(
        None, description="Absolute X coordinate on page to drop at (in pixels)"
    )
    coord_target_y: Optional[int] = Field(
        None, description="Absolute Y coordinate on page to drop at (in pixels)"
    )
