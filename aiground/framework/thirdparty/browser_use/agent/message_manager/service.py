...
from aiground.framework.thirdparty.browser_use.agent.prompts import AgentMessagePrompt
...
from aiground.framework.thirdparty.browser_use.browser.views import BrowserState
...
class MessageManager:
    ...
    def _filter_sensitive_data(self, message: BaseMessage) -> BaseMessage:
        ...
        def replace_sensitive(value: str) -> str:
            ...
            valid_sensitive_data = {
                k: v for k, v in self.settings.sensitive_data.items() if v
            }
    ...
    def add_tool_message(
        self, content: str, message_type: Optional[str] = None
    ) -> None:
