...
from aiground.framework.thirdparty.browser_use.agent.message_manager.views import (
    MessageManagerState,
)
from aiground.framework.thirdparty.browser_use.agent.playwright_script_generator import (
...
from aiground.framework.thirdparty.browser_use.browser.views import BrowserStateHistory
...
from aiground.framework.thirdparty.browser_use.dom.views import SelectorMap
...
class AgentSettings(BaseModel):
    ...
    save_playwright_script_path: Optional[str] = (
        None  # Path to save the generated Playwright script
    )
...
class AgentHistoryList(BaseModel):
    ...
    def save_as_playwright_script(
        ...
        try:
            ...
            generator = PlaywrightScriptGenerator(
                serialized_history, sensitive_data_keys, browser_config, context_config
            )
    ...
    @classmethod
    def load_from_file(
        cls, filepath: Union[str, Path], output_model: type[AgentOutput]
    ) -> AgentHistoryList:
