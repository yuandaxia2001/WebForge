...
from aiground.framework.thirdparty.browser_use.telemetry.views import BaseTelemetryEvent
from aiground.framework.thirdparty.browser_use.utils import singleton
...
class ProductTelemetry:
    ...
    def __init__(self) -> None:
        telemetry_disabled = (
            os.getenv("ANONYMIZED_TELEMETRY", "true").lower() == "false"
        )
        self.debug_logging = (
            os.getenv("BROWSER_USE_LOGGING_LEVEL", "info").lower() == "debug"
        )
