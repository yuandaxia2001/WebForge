...
class MCPClients(ToolCollection):
    ...
    async def connect_sse(
        self, server_url: str, server_id: str = "", headers=None
    ) -> None:
                ...
                try:
                    ...
                    if exit_stack:
                        try:
                            ...
                            elif "generator didn't stop" in str(e).lower():
                                LOGGER.warning(
                                    f"Generator didn't stop error during disconnect from {server_id}, continuing with cleanup: {e}"
                                )
                            else:
                                raise
